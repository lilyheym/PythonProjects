...
class ParentWindow(Frame):
      ...
      def sourceDir(self):
            ...
            # this allowd the path to be inserted into the Entry widget properly.
            self.source_dir.delete(0, END)
            # The .insert method will insert the useer selection to the source_dir Entry
      ...
      # Creates function to transger files from one directory to another
      def transferFiles(self):
            ...
            # Stuff for time file parameters
